...
Recovery correction verification: all eight setup tests passed, including oversized-context fallback, null/malformed/valid stalled context through the runtime reader, and missing-business recovery back to the form.
